...
import PC1.abaqus.truss_user_Input as user_input
...
# ANALYSIS STEP
# =============================================================================
model.FrequencyStep(name='ModalAnalysis', previous='Initial', numEigen=user_input.NB_EIGEN)
...
part.regenerate()
assembly.regenerate()
job = mdb.Job(name='TrussModalAnalysis', model='TrussModel')
